...
train_data_N_S = np.append(train_data_N[:181*2], train_data_S[:181*2])
train_data_N_S_BBB = np.append(train_data_BBB[:181*2], train_data_N_S)
train_all_data = np.append(train_data_V_W[:543*2], train_data_N_S_BBB)
...
checkpoint = keras.callbacks.ModelCheckpoint('DenseNet_Classfication_2_Whether_V_W_qrs_dimesion_of_1_Subjected_Oriented.h5', monitor='val_acc', verbose=1, save_best_only=True)
