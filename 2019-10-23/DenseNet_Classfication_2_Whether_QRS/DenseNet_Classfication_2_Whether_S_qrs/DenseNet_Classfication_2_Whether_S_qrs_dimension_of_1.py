...
train_data_N_BBB_VW = np.append(train_data_BBB[:181*2], train_data_N_VW)
train_all_data = np.append(train_data_S[:543*2], train_data_N_BBB_VW)
...
checkpoint = keras.callbacks.ModelCheckpoint('DenseNet_Classfication_2_Whether_S_qrs_dimension_of_1_depth_40_Subjected_Oriented.h5', monitor='val_acc', verbose=1, save_best_only=True)
