...
checkpoint = keras.callbacks.ModelCheckpoint('DenseNet_Classfication_2_Whether_AF_dimension_of_1_subject_oriented_depth_10_RR_Interphase_Normalization.h5', monitor='val_accuracy', verbose=1, save_best_only=True)
earlystop = keras.callbacks.EarlyStopping(monitor='val_accuracy', patience=100, verbose=1, mode='auto')
