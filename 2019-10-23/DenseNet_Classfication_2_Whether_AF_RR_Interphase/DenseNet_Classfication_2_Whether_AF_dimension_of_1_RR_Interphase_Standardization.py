...
checkpoint = keras.callbacks.ModelCheckpoint('DenseNet_Classfication_2_Whether_AF_dimension_of_1_subject_oriented_depth_22_RR_Interphase.h5', monitor='val_accuracy', verbose=1, save_best_only=True)
