...
model_AF = load_model('DenseNet_Classfication_2_Whether_AF_dimension_of_1_subject_oriented_depth_16_RR_Interphase_Normalization_0.98690.h5')
...
# %%time(这行代码只能在 Jupyter Notebook 中使用)
