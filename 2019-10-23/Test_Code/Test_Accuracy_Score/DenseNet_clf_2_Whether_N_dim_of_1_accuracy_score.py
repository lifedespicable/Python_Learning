...
test_data_N = np.append(test_N_except_VN, train_data_VN[78*2 : 96*2]).reshape(-1, 800)[:136*2]
...
test_data_S_VW = np.append(test_data_S, test_data_V_W[:45*2])
test_data_except_N = np.append(test_data_S_VW, test_data_BBB)
test_data_ALL = np.append(test_data_N, test_data_except_N)
